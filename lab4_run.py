...
def main():
    ...
    for form in ["0", "1", "4", "9"]:
        for _ in range(50):
            commands.append(
                f"python EvolutionLab4.py  -path  C:\\Users\\2002j\\Desktop\\pliki\\MastersPUT\\sem1\\BIAM\\Framsticks52 -sim \"eval-allcriteria.sim;deterministic.sim;sample-period-2.sim;only-body.sim\" -opt vertpos -max_numparts 30 -genformat {form} -popsize 50 -generations 200 -hof_size 1 -run-number {_}"
            )
